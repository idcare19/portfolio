...
export const websiteControlSchema = z.object({
  ...
  homepageDisplay: z.record(z.object({
    limit: z.union([z.number(), z.literal("all")]).optional(),
    itemsLimit: z.union([z.number(), z.literal("all")]).optional(),
    showOnlyFeatured: z.boolean().optional(),
    showViewMoreButton: z.boolean().optional(),
    viewMoreMode: z.enum(["navigate", "load-more"]).optional(),
    viewMoreButtonText: z.string().optional(),
    fullPageUrl: z.string().optional(),
    manualItemOrder: z.array(z.string()).optional(),
    initialItems: z.number().optional(),
    loadCount: z.number().optional(),
  })).default({}),
  sectionHomepage: z.record(z.object({
    limit: z.union([z.number(), z.literal("all")]).optional(),
    itemsLimit: z.union([z.number(), z.literal("all")]).optional(),
    showOnlyFeatured: z.boolean().optional(),
    showViewMoreButton: z.boolean().optional(),
...
export const siteDataSchema = z.object({
  ...
  projectsDetailed: z.array(
    z.object({
      ...
      featuredMirror: z.boolean().optional(),
      confidentialProject: z.boolean().optional(),
      ...
      cloudHosting: z.string().optional(),
      apisServicesUsed: z.string().optional(),
  ...
  homepageProjectSettings: z.object({
    count: z.union([z.literal(3), z.literal(4), z.literal(6), z.literal(8), z.literal(10), z.literal("all")]).default(6),
    buttonText: z.string().default("View More Projects"),
  }).optional().default({
    count: 6,
  ...
  githubConfig: z.object({
    ...
    useLiveGitHubAPI: z.boolean().default(true),
    showProfileHeader: z.boolean().default(true),
    ...
    showRepositoryCards: z.boolean().default(true),
    showPrivateRepos: z.boolean().default(false),
    showPrivateCommits: z.boolean().default(false),
    showCacheDebugDetails: z.boolean().default(false),
    showViewGitHubButton: z.boolean().default(true),
    showViewMoreButton: z.boolean().default(true),
    showLiveDemoButton: z.boolean().default(true),
    showViewRepositoryButton: z.boolean().default(true),
    ...
    repositoryCardsLimit: z.number().default(3),
    repositoryCardsSelectedRepositories: z.array(z.string()).default([]),
    repositoryCardsHideArchived: z.boolean().default(false),
    repositoryCardsHideForked: z.boolean().default(false),
    repositoryCardsHidePrivate: z.boolean().default(true),
    repositoryCardsSort: z.enum(["stars", "updated", "name", "manual"]).default("stars"),
    repositoryCardsManualOrder: z.array(z.string()).default([]),
    manualProfile: z.object({
      username: z.string().optional().default(''),
      avatarUrl: z.string().optional().default(''),
      bio: z.string().optional().default(''),
      profileUrl: z.string().optional().default(''),
      publicRepositories: z.number().default(0),
      stars: z.number().default(0),
      forks: z.number().default(0),
      followers: z.number().default(0),
      following: z.number().default(0),
      totalCommits: z.number().default(0),
      repositoryList: z.array(z.object({
      ...
      pinnedRepositories: z.array(z.object({
        name: z.string().optional().default(''),
        description: z.string().optional().default(''),
        url: z.string().optional().default(''),
        homepage: z.string().optional().default(''),
      ...
      buttons: z.object({
        viewGitHub: z.string().optional().default(''),
        viewMore: z.string().optional().default(''),
      }).optional(),
    }).optional(),
