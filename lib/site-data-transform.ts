...
export function normalizeSiteData(input: SiteData): SiteData {
  ...
  return {
    ...
    githubConfig: {
      ...
      useLiveGitHubAPI: input.githubConfig?.useLiveGitHubAPI ?? true,
      showProfileHeader: input.githubConfig?.showProfileHeader ?? true,
      showAvatar: input.githubConfig?.showAvatar ?? true,
      showBio: input.githubConfig?.showBio ?? true,
      showStats: input.githubConfig?.showStats ?? true,
      showLanguageBreakdown: input.githubConfig?.showLanguageBreakdown ?? false,
      showContributionCalendar: input.githubConfig?.showContributionCalendar ?? false,
      showInsights: input.githubConfig?.showInsights ?? false,
      showActivityTimeline: input.githubConfig?.showActivityTimeline ?? false,
      showRepositoryCards: input.githubConfig?.showRepositoryCards ?? true,
      showPrivateRepos: input.githubConfig?.showPrivateRepos ?? false,
      showPrivateCommits: input.githubConfig?.showPrivateCommits ?? false,
      showCacheDebugDetails: input.githubConfig?.showCacheDebugDetails ?? false,
      showViewGitHubButton: input.githubConfig?.showViewGitHubButton ?? true,
      showViewMoreButton: input.githubConfig?.showViewMoreButton ?? true,
      showLiveDemoButton: input.githubConfig?.showLiveDemoButton ?? true,
      showViewRepositoryButton: input.githubConfig?.showViewRepositoryButton ?? true,
      ...
      repositoryCardsLimit: input.githubConfig?.repositoryCardsLimit ?? 3,
      ...
      manualProfile: input.githubConfig?.manualProfile
        ? {
            username: input.githubConfig.manualProfile.username ?? "",
            avatarUrl: input.githubConfig.manualProfile.avatarUrl ?? "",
            bio: input.githubConfig.manualProfile.bio ?? "",
            profileUrl: input.githubConfig.manualProfile.profileUrl ?? "",
            publicRepositories: input.githubConfig.manualProfile.publicRepositories ?? 0,
            stars: input.githubConfig.manualProfile.stars ?? 0,
            forks: input.githubConfig.manualProfile.forks ?? 0,
            followers: input.githubConfig.manualProfile.followers ?? 0,
            following: input.githubConfig.manualProfile.following ?? 0,
            totalCommits: input.githubConfig.manualProfile.totalCommits ?? 0,
            repositoryList: input.githubConfig.manualProfile.repositoryList ?? [],
            pinnedRepositories: input.githubConfig.manualProfile.pinnedRepositories ?? [],
            buttons: {
              viewGitHub: input.githubConfig.manualProfile.buttons?.viewGitHub ?? "",
              viewMore: input.githubConfig.manualProfile.buttons?.viewMore ?? "",
            },
          }
        : undefined,
