...
export const sectionContentConfigs: Record<string, SectionContentConfig> = {
  ...
  "projects-content": {
    ...
    itemCrud: {
      ...
      groups: [
        { title: "Basic Info", fields: ["title", "shortDescription", "longDescription", "status", "category", "order", "isEnabled", "featured", "isFeatured"] },
        { title: "Media", fields: ["image", "thumbnail", "banner", "galleryImages"] },
        { title: "Links", fields: ["liveDemoUrl", "githubUrl", "backendRepo", "documentationUrl"] },
        { title: "Technologies", fields: ["techStack"] },
        { title: "Details", fields: ["client", "company", "role", "teamSize", "duration", "startDate", "endDate"] },
        { title: "Features", fields: ["features"] },
        { title: "Responsibilities", fields: ["responsibilities"] },
