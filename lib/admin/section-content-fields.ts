...
export const sectionContentConfigs: Record<string, SectionContentConfig> = {
  hero: {
    ...
    fields: [
      ...
      { label: "Profile Snapshot Title", path: "sections.hero.data.profileSnapshotTitle" },
      { label: "Profile Snapshot Description", path: "sections.hero.data.profileSnapshotDescription", type: "textarea" },
      { label: "Developer Badge Label", path: "sections.hero.data.developerBadgeLabel" },
      { label: "Resume Button Label", path: "sections.hero.data.resumeCtaLabel" },
    ],
    arrayFields: [
      {
      ...
      },
      {
        ...
        path: "sections.hero.data.highlightCards",
        itemLabel: "Highlight",
        createItem: () => ({ label: "", title: "", description: "", isEnabled: true, order: 1 }),
        fields: [
      ...
      {
        label: "Hero Stats",
        path: "sections.hero.data.profileStats",
        itemLabel: "Stat",
  ...
  "skills-content": {
    ...
    itemCrud: {
      ...
      itemLabel: "Skill",
      createItem: () => ({ id: `skill-${Date.now()}`, title: "", name: "", category: "Core Skills", icon: "", iconKey: "", iconUrl: "", iconColor: "", featured: false, level: 0, isEnabled: true, order: 1 }),
      fields: [
        { key: "title", label: "Title" },
        { key: "name", label: "Name" },
        { key: "category", label: "Category" },
        { key: "level", label: "Level", type: "number" },
        { key: "iconKey", label: "Icon Picker" },
        { key: "iconUrl", label: "Custom Icon URL" },
        { key: "iconColor", label: "Color" },
  ...
  "github-content": {
    ...
    fields: [
      ...
      { label: "Profile Label", path: "sections.github.data.profileLabel" },
      { label: "Repository Heading", path: "sections.github.data.repositoryHeading" },
      { label: "Languages Heading", path: "sections.github.data.languagesHeading" },
      { label: "GitHub Button Text", path: "sections.github.data.viewGitHubLabel" },
      { label: "Repository Button Text", path: "sections.github.data.repositoryButtonLabel" },
      { label: "Repositories Count Label", path: "sections.github.data.repositoryCountLabel" },
      { label: "Stars Count Label", path: "sections.github.data.starsCountLabel" },
      { label: "Forks Count Label", path: "sections.github.data.forksCountLabel" },
      { label: "Followers Count Label", path: "sections.github.data.followersCountLabel" },
    ],
  },
  "contact-content": {
    ...
    fields: [
      ...
      { label: "Form Subject", path: "sections.contact.data.formSubject" },
      { label: "Resume Button Label", path: "sections.contact.data.resumeButtonLabel" },
      { label: "Availability Label", path: "sections.contact.data.availabilityLabel" },
      { label: "Response Time Label", path: "sections.contact.data.responseTimeLabel" },
      { label: "Response Time Value", path: "sections.contact.data.responseTimeValue" },
      { label: "Status Label", path: "sections.contact.data.statusLabel" },
      { label: "Status Value", path: "sections.contact.data.statusValue" },
      { label: "Contact Options Label", path: "sections.contact.data.contactOptionsLabel" },
      { label: "Sending Label", path: "sections.contact.data.sendingLabel" },
  ...
  "footer-content": {
    ...
    fields: [
      ...
      { label: "Brand Text", path: "sections.footer.data.brandText" },
      { label: "Intro", path: "sections.footer.data.intro", type: "textarea" },
      { label: "Availability", path: "sections.footer.data.availability" },
      { label: "Navigation Label", path: "sections.footer.data.navigationLabel" },
      { label: "Socials Label", path: "sections.footer.data.socialsLabel" },
      { label: "Current Availability Label", path: "sections.footer.data.currentAvailabilityLabel" },
      { label: "Back To Top Label", path: "sections.footer.data.backToTopLabel" },
    ],
    arrayFields: [
      {
        label: "Quick Links",
