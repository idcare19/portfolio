...
export function DrawerForm({ open, title, children, onClose }: DrawerFormProps) {
  ...
  return (
    <div className="fixed inset-0 z-[120]" role="dialog" aria-modal="true">
      <button className="absolute inset-0 bg-[rgba(15,23,42,0.18)]" onClick={onClose} aria-label="Close drawer" />
      <aside className="absolute right-0 top-0 h-full w-full max-w-xl overflow-y-auto bg-admin-card p-5 shadow-2xl">
