    ...
    <div className="space-y-4">
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2">
          ...
          <input type="datetime-local" className="rounded-xl border border-slate-300 px-3 py-2" value={control.popupAnnouncement.startDate} onChange={(e) => setControl({ popupAnnouncement: { ...control.popupAnnouncement, startDate: e.target.value } })} />
          <input type="datetime-local" className="rounded-xl border border-slate-300 px-3 py-2" value={control.popupAnnouncement.endDate} onChange={(e) => setControl({ popupAnnouncement: { ...control.popupAnnouncement, endDate: e.target.value } })} />
        </div>
      </section>
