...
export const adminNavSections: AdminNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "FAQ Content", href: "/admin/faq-content" },
      { label: "Achievements Content", href: "/admin/achievements-content" },
      { label: "Companies Content", href: "/admin/companies-content" },
      { label: "Certificates Content", href: "/admin/certificates-content" },
      { label: "Open Source Content", href: "/admin/open-source-content" },
